				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							...
							<div class="row align-items-center">
								<div class="col-md-6">
									<h2 class="mb-sm-0 font-size-32">Daftar Kategori Instrumen</h2>
								</div>
								...
								<div class="col-md-6">
									<div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
										...
										<div>
											<a class="btn btn-primary" onclick="Fungsi_Tambah()"><i class="bx bx-plus me-1"></i> Tambah Baru</a>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var table = $('#tabel_instrumen').DataTable({
			...
			// 	processing: true,
			// 	serverSide: true,
			// 	ajax: '<?php echo site_url('Sysadmin/list_kategori_instrumen') ?>',
			// });

			// table.buttons().container()
			// 	.appendTo('#tabel_instrumen_wrapper .col-md-6:eq(0)');
			...
			"ajax": {
				"url": "<?php echo site_url('Sysadmin/list_kategori_instrumen') ?>",
				"type": "POST"
			},
	...
	function save() {
		...
		if (save_method == 'add') {
			...
			url = "<?php echo site_url('sysadmin/Save_Update') ?>";
		}
	...
	function Btn_Edit(id_instrumen) {
		...
		$.ajax({
			url: "<?php echo site_url('Sysadmin/Fungsi_Edit') ?>/" + id_instrumen,
			type: "GET",
			dataType: "JSON",
			success: function(data) {
				...
				$('[name="periode"]').val(data.periode_kalibrasi);
