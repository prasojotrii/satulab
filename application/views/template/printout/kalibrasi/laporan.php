...
<body style="font-size: 12px">
	...
	<table width="100%">
		<tr style="text-align: center;">
			<td style="text-align: center;">
				<span style="font-size: 13px"><b>Laporan Kalibrasi Alat Gelas (Volumetrik)</b></span>
			</td>
		</tr>
	</table>
	...
	<br>
	<p align="left">
		<span style="font-size: 12px"><b><u>Kondisi Lingkungan :</b></u></span> <br>
	</p>
	<!-- <br> -->
	<table>
		<tr>

			<td align="left">Suhu (°C)</td>
			<td> : <?= $suhu_avg ?></td>

		</tr>
		<tr>

			<td align="left">Kelembaban (%) </td>
			<td> : <?= $kelembaban_avg ?></td>
	...
	<table style="border: 1px solid black;border-collapse: collapse;font-size: 11px" width="100%">
		<thead>
			<tr style="margin: 5px">
				<th style="border: 1px solid black;">Volume Nominal</th>
				<th style="border: 1px solid black;">Volume Aktual (V20)</th>
				<th style="border: 1px solid black;">Koreksi</th>
				<th style="border: 1px solid black;">Ketidakpastian (±)</th>
			</tr>
			<tr style="margin: 5px">
				<th style="border: 1px solid black;">mL</th>
				<th style="border: 1px solid black;">mL</th>
				<th style="border: 1px solid black;">mL</th>
				<th style="border: 1px solid black;"><span>&#181;</span>L</th>
			</tr>
		</thead>
		<tbody>
			<?php
			...
			?>
				...
				<tr style="margin: 5px">
					<td style="border: 1px solid black;font-size: 13px; text-align: center;"><?= $row['skala'] ?></td>
					<td style="border: 1px solid black;font-size: 13px; text-align: center;"><?= $row['V20'] ?></td>
					<td style="border: 1px solid black;font-size: 13px; text-align: center;"><?= $row['koreksi'] ?></td>
					<td style="border: 1px solid black;font-size: 13px; text-align: center;"><?= $row['ketidakpastian'] ?></td>
				</tr>
	...
	<table>
		<tr>
			<td align="left" style="font-size: 9px">Dokumen Terkait :</td>
			<th></th>
			<td></td>
			<td></td>
		...
		<tr>
			<td align="left" width="100px" style="font-size: 9px">1. IK/PM.6-4/PA/156</td>
			<td style="font-size: 9px">: Intruksi Kerja Kalibrasi Alat Gelas</td>
			<td></td>
			<td></td>

		</tr>
		<tr>
			<td align="left" width="100px" style="font-size: 9px">2. FR/PR/PM.6-4/6/6</td>
			<td style="font-size: 9px">: Laporan Kalibrasi Alat Gelas</td>
			<td></td>
			<td></td>
	...
	<table width="100%">
		...
		<tr>
			...
			<td align="center" width="33,3%">Disetujui Oleh<br><br><br><br><br><u>( <?= $dataSession['kepalaunit']; ?> )</u><b><br>Ka. Lab. Analisa</b></td>
		</tr>
	</table>
