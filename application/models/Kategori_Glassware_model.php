<?php
class Kategori_Glassware_model extends CI_Model
{
    var $table = 'tb_kategori_glassware';
    var $table2 = 'tb_daftar_glassware';
    ...
    {
        $this->db->order_by('kalibrasi', 'DESC');
        $this->db->order_by('id_instrumen', 'ASC');
    ...
    function JumlahTotal($id_instrumen)
    {
