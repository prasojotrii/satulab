...
class User_Role_model extends CI_Model
{
    ...
    var $column_order = array(null, null, '	id_role', 'nama_role', 'nama_halaman', 'title', 'url', 'view', 'create', 'update', 'delete'); //set column field database for datatable orderable
    var $column_search = array('id_role', 'nama_role', 'nama_halaman', 'nama_role', 'title', 'url', 'view', 'create', 'update', 'delete'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    var $order = array('nama_role' => 'asc'); // default order 
    ...
    public function delete_by_id($id_role)
    {
        $this->db->where('id_role', $id_role);
