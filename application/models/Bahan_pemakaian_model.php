<?php
class Bahan_pemakaian_model extends CI_Model
{
    var $table = 'tb_bahan_pemakaian';
    var $column_order = array(null, null); //set column field database for datatable orderable
    var $column_search = array('kode_bahan'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    ...
    {
        if ($this->input->post('kode_bahan')) {
            $this->db->where('kode_bahan', $this->input->post('kode_bahan'));
        }
    ...
    function get_datatables()
    {
        ...
        $this->db->order_by('jumlah_bahan_sisa', 'DESC');
    ...
    public function delete_by_kode_bahan($kode_bahan)
    {
