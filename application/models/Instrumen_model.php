...
{
    var $table = 'tb_daftar_instrumen';
    var $column_order = array(null, null, 'id_aset', 'no_aset',  'id_instrumen', 'tipe_instrumen', 'merek', 'seri', 'serial_number', 'tahun', 'lokasi', 'aktif', 'kondisi', 'status_kalibrasi', 'awal_kalibrasi', 'selanjutnnya_kalibrasi', 'user_input', 'tanggal_input', null);

    //set column field database for datatable orderable

    var $column_search = array('id_aset', 'no_aset', 'id_instrumen', 'tipe_instrumen', 'merek', 'seri', 'serial_number', 'tahun', 'lokasi', 'aktif', 'status_kalibrasi', 'awal_kalibrasi', 'selanjutnnya_kalibrasi', 'user_input', 'tanggal_input',);
    ...
    function jumlah()
    {
        $query = $this->db->query('SELECT * FROM tb_daftar_instrumen');
        return $query->num_rows();
    }
    ...
    public function dataKategori()
    {
        ...
        $query = $this->db->get('tb_kategori_instrumen');
        return $query->result();
    }
    ...
    function cari($tipe_instrumen)
    {
        $query = $this->db->get_where('tb_kategori_instrumen', array('kategori_instrumen' => $tipe_instrumen));
        return $query;
    }
    ...
    {
        $this->db->select('LEFT(tb_daftar_instrumen.id_aset,4) as kode', FALSE);
        $this->db->order_by('kode', 'DESC');
        $this->db->limit(1);
        $query = $this->db->get('tb_daftar_instrumen');      //cek dulu apakah ada sudah ada kode di tabel.    
        if ($query->num_rows() <> 0) {
    ...
    public function KodeMKR()
    {
        ...
        $this->db->order_by('kode', 'DESC');
        $this->db->limit(1);
        $query = $this->db->get('tb_daftar_instrumen');
    ...
    {
        // $this->db->select('LEFT(tb_log_instrumen.id_log_instrumen,4) as kode', FALSE);
        // $this->db->order_by('kode', 'DESC');
        // $this->db->limit(1);
        ...
        $this->db->select('RIGHT(tb_log_instrumen.id_log_instrumen,8) as kode', FALSE);

        $this->db->order_by('id_log_instrumen', 'DESC');
